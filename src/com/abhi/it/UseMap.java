...
public class UseMap {
	public static void main(String[] args) {
		...
		List<Employee> listal = Arrays.asList(new Employee("Abhi It", "abhishekonedev01@gmail.com", 26, 43000.00),
		...
		listal.stream().filter(i->i.getSalary()<=50000).map(i->i.getName()+" "+i.getAge()).forEach(i->System.out.println(i));
